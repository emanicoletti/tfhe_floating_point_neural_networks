...
pub fn resnet20_fp32() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut residual_block_1 = ResidualBlock::<u32>::new("res_block_1".to_string(), Some(9));

    let mut residual_block_2 = ResidualBlock::<u32>::new("res_block_2".to_string(), Some(9));

    let mut residual_block_3 = ResidualBlock::<u32>::new("res_block_3".to_string(), Some(9));

    let mut residual_block_4 = ResidualBlock::<u32>::new("res_block_4".to_string(), Some(9));

    let mut residual_block_5 = ResidualBlock::<u32>::new("res_block_5".to_string(), Some(9));

    let mut residual_block_6 = ResidualBlock::<u32>::new("res_block_6".to_string(), Some(9));

    let mut residual_block_7 = ResidualBlock::<u32>::new("res_block_7".to_string(), Some(9));

    let mut residual_block_8 = ResidualBlock::<u32>::new("res_block_8".to_string(), Some(9));

    let mut residual_block_9 = ResidualBlock::<u32>::new("res_block_9".to_string(), Some(9));
