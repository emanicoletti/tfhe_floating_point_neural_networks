...
pub fn add32(a: u32, b: u32) -> u32 {
    ...
    x_mant = (&x & 0b0000_0000_0111_1111_1111_1111_1111_1111u32)
    ...
    if overflow_flag { ov_result } else { result }
}

pub fn same_sign_add32(a: u32, b: u32) -> u32 {
    let ns_a = &a & 0b0111_1111_1111_1111_1111_1111_1111_1111u32;
    let ns_b = &b & 0b0111_1111_1111_1111_1111_1111_1111_1111u32;
    let (x, y);
...
pub fn backward_relu32(a: u32, grad_output: u32) -> u32 {
    if a == 1u32 { grad_output } else { 0u32 }
}
...
static EXP_TO_RESULT_U32: [u32; 128] = [
    0b00111111100000000000000000000000u32,
    0b00111111100000000000000000000000u32,
    0b01000000000000000000000000000000u32,
    0b01000000000000000000000000000000u32,
    0b01000000100000000000000000000000u32,
    0b01000000100000000000000000000000u32,
    0b01000000100000000000000000000000u32,
    0b01000000100000000000000000000000u32,
    0b01000001000000000000000000000000u32,
    0b01000001000000000000000000000000u32,
    0b01000001000000000000000000000000u32,
    0b01000001000000000000000000000000u32,
    0b01000001000000000000000000000000u32,
    ...
    0b01000001000000000000000000000000u32,
    0b01000001000000000000000000000000u32,
    0b01000001100000000000000000000000u32,
    0b01000001100000000000000000000000u32,
    0b01000001100000000000000000000000u32,
    0b01000001100000000000000000000000u32,
    0b01000001100000000000000000000000u32,
    ...
    0b01000001100000000000000000000000u32,
    0b01000001100000000000000000000000u32,
    0b01000010000000000000000000000000u32,
    0b01000010000000000000000000000000u32,
    0b01000010000000000000000000000000u32,
    0b01000010000000000000000000000000u32,
    0b01000010000000000000000000000000u32,
    ...
    0b01000010000000000000000000000000u32,
    0b01000010000000000000000000000000u32,
    0b01000010100000000000000000000000u32,
    0b01000010100000000000000000000000u32,
    0b01000010100000000000000000000000u32,
    0b01000010100000000000000000000000u32,
    0b01000010100000000000000000000000u32,
...
pub fn same_sign_add16(a: u16, b: u16) -> u16 {
    let ns_a = &a & 0b0111_1111_1111_1111u16;
    let ns_b = &b & 0b0111_1111_1111_1111u16;
    let (x, y);
...
pub fn backward_relu16(a: u16, grad_output: u16) -> u16 {
    if a == 1u16 { grad_output } else { 0u16 }
}

#[allow(dead_code)]
static EXP_TO_RESULT_U16: [u16; 16] = [
    15360u16, 15360u16, 16384u16, 16384u16, 17408u16, 17408u16, 17408u16, 17408u16, 18432u16,
    18432u16, 18432u16, 18432u16, 18432u16, 18432u16, 18432u16, 18432u16,
];

#[allow(dead_code)]
pub fn log2_u16(a: u16) -> u16 {
...
pub fn lmul_tanh32(a: u32) -> (u32, u32) {
    let (out, dx) = match a {
        3221225472u32..=4294967295u32 => (3212836864u32, 0u32), // [-∞, -2]
        ...
        1073741825u32..=2147483647u32 => (1065353217u32, 0u32), // [2, ∞]
    };
    (out, dx)
}
...
#[allow(dead_code)]
pub fn pam_mul32(a: u32, b: u32) -> u32 {
    let a_sign = &a >> 31u32;
    let b_sign = &b >> 31u32;
    let mut sign = &a_sign ^ b_sign;
    sign <<= 31u32;
...
#[allow(dead_code)]
pub fn pam_div32(a: u32, b: u32) -> u32 {
    let a_sign = &a >> 31u32;
    let b_sign = &b >> 31u32;
    let mut sign = &a_sign ^ b_sign;
    sign <<= 31u32;
...
#[allow(dead_code)]
pub fn pam_tanh32(a: u32) -> (u32, u32) {
    let (out, dx) = match a {
        3221225472u32..=4294967295u32 => (3212836864u32, 0u32), // [-∞, -2]
        3210040661u32..=3221225471u32 => {
...
pub fn lmul_tanh16(a: u16) -> (u16, u16) {
    let (out, dx) = match a {
        49152u16..=65535u16 => (48128u16, 0u16), // [-∞, -2]
        47787u16..=49151u16 => {
        ...
        16385u16..=32767u16 => (15360u16, 0u16), // [2, ∞]
    };
    (out, dx)
}
...
#[allow(dead_code)]
pub fn pam_mul16(a: u16, b: u16) -> u16 {
    let a_sign = &a >> 15u16;
    let b_sign = &b >> 15u16;
    let mut sign = &a_sign ^ b_sign;
    sign <<= 15u16;
...
#[allow(dead_code)]
pub fn pam_div16(a: u16, b: u16) -> u16 {
    let a_sign = &a >> 15u16;
    let b_sign = &b >> 15u16;
    let mut sign = &a_sign ^ b_sign;
    sign <<= 15u16;
...
#[allow(dead_code)]
pub fn pam_tanh16(a: u16) -> (u16, u16) {
    let (out, dx) = match a {
        49152u16..=65535u16 => (48128u16, 0u16), // [-∞, -2]
        47787u16..=49151u16 => {
...
#[allow(dead_code)]
pub fn canonical_tanh16(a: u16) -> (u16, u16) {
...
#[allow(dead_code)]
pub fn canonical_tanh32(a: u32) -> (u32, u32) {
...
#[allow(dead_code)]
pub fn canonical_sub32(a: u32, b: u32) -> u32 {
    (f32::from_bits(a) - f32::from_bits(b)).to_bits()
}

#[allow(dead_code)]
pub fn canonical_div32(a: u32, b: u32) -> u32 {
    (f32::from_bits(a) / f32::from_bits(b)).to_bits()
}

#[allow(dead_code)]
pub fn canonical_mul32(a: u32, b: u32) -> u32 {
    (f32::from_bits(a) * f32::from_bits(b)).to_bits()
}

#[allow(dead_code)]
pub fn canonical_add32(a: u32, b: u32) -> u32 {
    (f32::from_bits(a) + f32::from_bits(b)).to_bits()
}

#[allow(dead_code)]
pub fn canonical_sqrt32(a: u32) -> u32 {
    (f32::from_bits(a).sqrt()).to_bits()
}

#[allow(dead_code)]
pub fn canonical_add16(a: u16, b: u16) -> u16 {
    (f16::from_bits(a) + f16::from_bits(b)).to_bits()
}

#[allow(dead_code)]
pub fn canonical_sub16(a: u16, b: u16) -> u16 {
    (f16::from_bits(a) - f16::from_bits(b)).to_bits()
}

#[allow(dead_code)]
pub fn canonical_div16(a: u16, b: u16) -> u16 {
    (f16::from_bits(a) / f16::from_bits(b)).to_bits()
}

#[allow(dead_code)]
pub fn canonical_mul16(a: u16, b: u16) -> u16 {
    (f16::from_bits(a) * f16::from_bits(b)).to_bits()
}
